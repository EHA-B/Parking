    ...
    <section class="board">
        <div class="container">
            ...
            <div class="customer-details">
                ...
                <p><strong>عدد الساعات:</strong> <?php echo htmlspecialchars($customer->hours ?? 'غير محدد'); ?></p>
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo route('customers.index'); ?>" class="btn btn-secondary">العودة للعملاء</a>
            </div>
        </div>
    </section>
</body>
