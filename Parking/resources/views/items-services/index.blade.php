...
<head>
    ...
    <style>
        ...
        .items-section, .services-section {
            width: 48%;
            padding: 20px;
                ...
                <div class="form-section">
                    <form action="{{ route('items.store') }}" method="POST">
                        ...
                        <div class="form">
                            ...
                            <div class="input-form">
                                <input type="number" step="0.01" name="price" class="inp-text" placeholder="Price" required>
                                <label>: السعر</label>
                            </div>
                ...
                <div class="form-section">
                    <form action="{{ route('services.store') }}" method="POST">
                        ...
                        <div class="form">
                            ...
                            <div class="input-form">
                                <input type="number" step="0.01" name="cost" class="inp-text" placeholder="Service Cost" required>
